...
- [ ] **Q3** Không rõ — chưa chốt, giữ mặc định tạm (dùng cột S)
...
- [ ] **Q8** Quyết định thương mại — cấp quản lý PSBV, ngoài phạm vi kỹ thuật; chưa có RFQ nào ở `QUOTED_TO_CLIENT` (§6.4) nên chưa cấp bách
